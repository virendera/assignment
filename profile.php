                      ...
                      <div class="form-group">
                                ...
                                <div class="author" >
                                  <a href="javascript:void(0)">
                                    ...
                                    <h5 class="title"><input type="file" style="font-size: small;" name="image" id="fileInput" value="<?php echo $_SESSION['image'];?>"></h5>
                                  </a>
                                </div>
        			              </div>
                     ...
                     <div class="col-md-4 pr-md-1">
                      ...
                      <div class="form-group">
                        ...
                        elseif($_SESSION['usertype']==1)
                        {
                          ...
                          <option value="teacher"  label="Teacher" > Teacher </option >
                          <option value="student"  label="Student"> Student </option >                          
                          <option value="admin" selected label="Administrator"> Administrator </option >                          
                          <?php
                        }
                        else
                        {
